...
('MX','Mexico',10500,6.30),
('UK','United Kingdom',46000,4.20),
--updates--
('VE','Venezuela',30000,12.00),  -- Venezuela: high inflation test #1
('AR','Argentina',25000,12.00);  -- Argentina: high inflation test #2
...
--not to alter the created tables above and only test the changes --
UPDATE country SET gdp = 65000.00 WHERE country_code = 'CA';
UPDATE country SET inflation = 2.50 WHERE country_code = 'US';